...
export default class Renderer {
  ...
  constructor(canvasNode) {
    ...
    this.textureCoordinateAttr = this.gl.getAttribLocation(
      this.program,
      `a_textureCoordinates`,
    )
    this.transformationUni = this.gl.getUniformLocation(
      this.program,
      `u_transform`,
    )
  }
  ...
  _renderContainer(container, parentTransformationMatrix) {
    ...
    if (container.image) {
      ...
      this._setRectangle(
        rectBuffer,
        container.image.naturalWidth,
        container.image.naturalHeight,
      )
    ...
    container.children.forEach(child =>
      this._renderContainer(child, localTransformationMatrix),
    )
  }
